...
`communication.intent.deliver.request` (TDD 3C §5, same Fork D precedent
`digital-twin-engine`'s own `clients/communication_client.py` established --
this module mirrors that one's structure exactly).
...
from nova_capability_engine.domain.ports import EventPublisher
