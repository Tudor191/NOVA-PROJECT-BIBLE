"""nova_executive_cognition_engine's FastAPI entrypoint."""
...
from nova_executive_cognition_engine.api.health import router as health_router
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    fastapi_app = FastAPI(title="executive-cognition-engine", version="0.1.0", lifespan=lifespan)
