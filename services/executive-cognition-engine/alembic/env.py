"""Alembic environment for the Executive Cognition Engine's `executive`
Postgres schema.
...
from nova_executive_cognition_engine.repository.models import Base
...
def _do_run_migrations(connection: Connection) -> None:
    ...
    # (not `executive`) -- that schema doesn't exist yet on a fresh database
