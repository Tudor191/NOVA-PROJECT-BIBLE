...
for pipeline unit tests that need to observe the Permission Review
stage's disclosure calls without a real Event Bus round trip (structurally
identical to `capability-engine`'s own `tests/fakes/communication_port.py`,
the Fork D precedent TDD 3E §5 cites)."""
