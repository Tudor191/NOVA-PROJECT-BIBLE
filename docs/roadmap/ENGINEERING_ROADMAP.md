...
Technical Design Document work for **2D-A (Voice & Communication Foundation)** is
now underway. Per direct user instruction, this phase's original single-milestone
