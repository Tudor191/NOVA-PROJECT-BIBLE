...
10. **Phase 2D-D, Phase 3A, both Phase 3B units, Phase 3C** — **no Production SLOC or Total SLOC figure reported at all.** This is the reporting gap this whole `docs/project-health/` system exists to make visible and prevent from recurring silently.
