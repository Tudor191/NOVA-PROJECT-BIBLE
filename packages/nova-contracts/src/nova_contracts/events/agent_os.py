...
@register_payload("agent_os.registry.list_packages.request")
class AgentOsListPackagesRequestPayload(BaseModel):
...
@register_payload("agent_os.registry.list_packages.reply")
class AgentOsListPackagesReplyPayload(BaseModel):
    ...
    packages: list[AgentPackageSnapshot] = Field(default_factory=list)
    schema_version: int = 1
